...
public class GameDriver extends Application {
	...
	public void start(Stage stage) throws FileNotFoundException {   
	      ...
	      scene.setOnKeyPressed(new EventHandler<KeyEvent>() {
			...
			public void handle(KeyEvent event) {
				...
				case UP: 	player.addY(-player.getMaxSpeed());	player.setDirection(1);		break;
				case DOWN: 	player.addY(player.getMaxSpeed());	player.setDirection(3);		break;
				case LEFT: 	player.addX(-player.getMaxSpeed());	player.setDirection(4);		break;
				case RIGHT: player.addX(player.getMaxSpeed());	player.setDirection(2);		break;
			}
	      }
	...
	public void step(ImageView imageView, ImageView viewEnemy1) {
		...
		if (framesRun % player.getFireRate() == 0) {
			player.shoot();
		}
